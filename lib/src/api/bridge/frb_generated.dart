...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1240836150;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiPeerSetWebrtcLogLevel({required WebrtcLogLevel level});

  Future<void> crateApiTransceiverStopTransceiver({
    required ArcRtpTransceiver transceiver,
  });

  Future<bool> crateApiMediaSysAudioCaptureIsAvailable();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiPeerSetWebrtcLogLevel({required WebrtcLogLevel level}) {
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_webrtc_log_level(level, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 42,
        ...
        constMeta: kCrateApiPeerSetWebrtcLogLevelConstMeta,
        argValues: [level],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiPeerSetWebrtcLogLevelConstMeta =>
      const TaskConstMeta(
        debugName: "set_webrtc_log_level",
        argNames: ["level"],
      );
  ...
  Future<bool> crateApiMediaSysAudioCaptureIsAvailable() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMediaSysAudioCaptureIsAvailableConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMediaSysAudioCaptureIsAvailableConstMeta =>
      const TaskConstMeta(
        debugName: "sys_audio_capture_is_available",
        argNames: [],
      );
  ...
  AudioConstraints dco_decode_audio_constraints(dynamic raw) {
    ...
    return AudioConstraints(
      ...
      processing: dco_decode_opt_box_autoadd_audio_processing_constraints(
        arr[1],
      ),
  ...
  dco_decode_opt_box_autoadd_audio_processing_constraints(dynamic raw) {
    ...
    return raw == null
        ? null
        : dco_decode_box_autoadd_audio_processing_constraints(raw);
  }
  ...
  WebrtcLogLevel dco_decode_webrtc_log_level(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return WebrtcLogLevel.values[raw as int];
  }
  ...
  AudioConstraints sse_decode_audio_constraints(SseDeserializer deserializer) {
    ...
    var var_processing =
        sse_decode_opt_box_autoadd_audio_processing_constraints(deserializer);
  ...
  sse_decode_opt_box_autoadd_audio_processing_constraints(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_audio_processing_constraints(
        deserializer,
      ));
    } else {
      return null;
  ...
  WebrtcLogLevel sse_decode_webrtc_log_level(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return WebrtcLogLevel.values[inner];
  }
  ...
  void sse_encode_audio_constraints(
    ...
    sse_encode_opt_box_autoadd_audio_processing_constraints(
      self.processing,
      serializer,
    );
  ...
  void sse_encode_opt_box_autoadd_audio_processing_constraints(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_audio_processing_constraints(self, serializer);
    }
  }
