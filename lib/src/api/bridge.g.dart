...
abstract class MedeaFlutterWebrtcNative {
  ...
  Future<void> setVolumeObserverEnabled(
      {required String trackId,
      int? peerId,
      required bool enabled,
      dynamic hint});

  FlutterRustBridgeTaskConstMeta get kSetVolumeObserverEnabledConstMeta;
...
class MedeaFlutterWebrtcNativeImpl implements MedeaFlutterWebrtcNative {
  ...
  Future<void> setVolumeObserverEnabled(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_set_volume_observer_enabled(port_, arg0, arg1, arg2),
      parseSuccessData: _wire2api_unit,
      parseErrorData: _wire2api_FrbAnyhowException,
      constMeta: kSetVolumeObserverEnabledConstMeta,
  ...
  FlutterRustBridgeTaskConstMeta get kSetVolumeObserverEnabledConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "set_volume_observer_enabled",
...
class MedeaFlutterWebrtcNativeWire implements FlutterRustBridgeWireBase {
  ...
  void wire_set_volume_observer_enabled(
    int port_,
    ffi.Pointer<wire_uint_8_list> track_id,
    ffi.Pointer<ffi.Uint64> peer_id,
    bool enabled,
  ) {
    return _wire_set_volume_observer_enabled(
      port_,
      track_id,
      peer_id,
      enabled,
  ...
  late final _wire_set_volume_observer_enabledPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Int64,
              ffi.Pointer<wire_uint_8_list>,
              ffi.Pointer<ffi.Uint64>,
              ffi.Bool)>>('wire_set_volume_observer_enabled');
  late final _wire_set_volume_observer_enabled =
      _wire_set_volume_observer_enabledPtr.asFunction<
