...
abstract class MedeaFlutterWebrtcNative {
  ...
  Future<int?> trackHieght(
      {required String trackId, required MediaType kind, dynamic hint});

  FlutterRustBridgeTaskConstMeta get kTrackHieghtConstMeta;
...
class MedeaFlutterWebrtcNativeImpl implements MedeaFlutterWebrtcNative {
  ...
  Future<int?> trackHieght(
    ...
    var arg1 = api2wire_media_type(kind);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_track_hieght(port_, arg0, arg1),
      parseSuccessData: _wire2api_opt_box_autoadd_i32,
      constMeta: kTrackHieghtConstMeta,
      argValues: [trackId, kind],
      hint: hint,
    ));
  }
...
class MedeaFlutterWebrtcNativeWire implements FlutterRustBridgeWireBase {
  ...
  void wire_track_hieght(
    int port_,
    ffi.Pointer<wire_uint_8_list> track_id,
    int kind,
  ) {
    return _wire_track_hieght(
      port_,
      track_id,
      kind,
    );
  ...
  late final _wire_track_hieghtPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>,
              ffi.Int32)>>('wire_track_hieght');
  late final _wire_track_hieght = _wire_track_hieghtPtr
      .asFunction<void Function(int, ffi.Pointer<wire_uint_8_list>, int)>();
