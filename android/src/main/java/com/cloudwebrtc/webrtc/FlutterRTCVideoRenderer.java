...
public class FlutterRTCVideoRenderer implements EventChannel.StreamHandler {
  ...
  private int id = -1;
  @Nullable private MediaStream mediaStream;
  ...
  /**
   * The {@code RendererEvents} which listens to rendering events reported by {@link
  ...
  @NonNull private final SurfaceTextureRenderer surfaceTextureRenderer;
  ...
  public FlutterRTCVideoRenderer(
      SurfaceTexture texture, TextureRegistry.SurfaceTextureEntry entry) {
  ...
  /**
   * Stops rendering {@link #videoTrack} and releases the associated acquired resources (if
  ...
  /**
   * Sets the {@code MediaStream} to be rendered by this {@code FlutterRTCVideoRenderer}. The
   * implementation renders the first {@link VideoTrack}, if any, of the specified {@code
   * mediaStream}.
   *
   * @param mediaStream The {@code MediaStream} to be rendered by this {@code
   *     FlutterRTCVideoRenderer} or {@code null}.
   */
   ...
   *
   * @param videoTrack The {@code VideoTrack} to be rendered by this {@code FlutterRTCVideoRenderer}
   *     or {@code null}.
   */
  ...
  /**
   * Starts rendering {@link #videoTrack} if rendering is not in progress and all preconditions for
   * the start of rendering are met.
   */
