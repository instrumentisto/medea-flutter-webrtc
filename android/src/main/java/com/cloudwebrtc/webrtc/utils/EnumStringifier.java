...
public class EnumStringifier {
    ...
    @Nullable
    public static String transceiverDirectionString(RtpTransceiver.RtpTransceiverDirection direction) {
        switch (direction) {
            case SEND_RECV:
                return "sendrecv";
            case SEND_ONLY:
    ...
    public static RtpTransceiver.RtpTransceiverDirection stringToTransceiverDirection(String direction) {
        switch (direction) {
            case "sendrecv":
