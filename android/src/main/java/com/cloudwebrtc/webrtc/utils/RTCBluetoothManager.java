...
public class RTCBluetoothManager {
  ...
  @NonNull private final Context apprtcContext;
  ...
  @NonNull private final BluetoothProfile.ServiceListener bluetoothServiceListener;
  ...
  @NonNull private final BroadcastReceiver bluetoothHeadsetReceiver;
  ...
  private boolean hasPermission() {
    return apprtcContext.checkPermission(
            android.Manifest.permission.BLUETOOTH, Process.myPid(), Process.myUid())
