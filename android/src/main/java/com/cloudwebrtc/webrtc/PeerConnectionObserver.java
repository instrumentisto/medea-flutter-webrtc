...
class PeerConnectionObserver implements PeerConnection.Observer, EventChannel.StreamHandler {
  ...
  private RtpTransceiver.RtpTransceiverInit mapToRtpTransceiverInit(
    ...
    List<String> streamIds =
        Optional.ofNullable((List<String>) parameters.get("streamIds")).orElse(new ArrayList<>());
    String direction = Optional.ofNullable((String) parameters.get("direction")).orElse("sendrecv");
  ...
  private RtpParameters updateRtpParameters(
      @NonNull Map<String, Object> newParameters, @NonNull RtpParameters parameters) {
  ...
  public void addTransceiver(
      ...
      @Nullable Map<String, Object> transceiverInit,
  ...
  public void rtpTransceiverSetDirection(
      @NonNull String direction, int transceiverId, @NonNull Result result) {
  ...
  public void rtpTransceiverGetDirection(int transceiverId, @NonNull Result result) {
    ...
    ConstraintsMap params = new ConstraintsMap();
    params.putString(
        "result", EnumStringifier.transceiverDirectionString(transceiver.getDirection()));
    result.success(params.toMap());
  }
  ...
  public void getTransceivers(@NonNull Result result) {
    ...
    for (RtpTransceiver receiver : transceivers) {
      transceiversParams.pushMap(
          new ConstraintsMap(ObjectExporter.exportTransceiver(id, receiver)));
      id++;
    }
    ConstraintsMap params = new ConstraintsMap();
