...
public class GetUserMediaImpl {
   ...
   * requested.
   */
  void getUserMedia(final ConstraintsMap constraints, final Result result) {
  ...
  private void getUserMedia(
      ConstraintsMap constraints, Result result, List<String> grantedPermissions) {
  ...
  private void requestPermissions(
    ...
    PermissionUtils.requestPermissions(
        context, activity, permissions.toArray(new String[permissions.size()]), callback);
  }
