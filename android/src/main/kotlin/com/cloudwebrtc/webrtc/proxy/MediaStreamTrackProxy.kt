 ...
 * @property deviceId  Unique ID of device on which this [MediaStreamTrackProxy]
 *                     is based.
 * @property source    [MediaTrackSource] from which this
 *                     [MediaStreamTrackProxy] is created. `null` for
 *                     [MediaStreamTrackProxy]s received from the remote side.
 */
class MediaStreamTrackProxy(
    ...
    /**
     * Creates a new [MediaStreamTrackProxy] based on the same
     * [MediaTrackSource] as this [MediaStreamTrackProxy].
     *
     ...
     *
     * Media source will be disposed only if there is no another
     * [MediaStreamTrackProxy] depending on a [MediaTrackSource].
     */
    fun stop() {
        if (!isStopped) {
            isStopped = true
     ...
     *
     * @param enabled  State which will be set to the underlying
     *                 [MediaStreamTrack].
     */
