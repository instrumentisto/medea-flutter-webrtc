...
void main() {
  ...
  testWidgets('Add Ice Candidate', (WidgetTester tester) async {
    ...
    pc1.onIceCandidate((candidate) async {
      print('111 new candidate: ${candidate.sdpMid} ${candidate.sdpMLineIndex} ${candidate.candidate}');
      await pc2.addIceCandidate(candidate);
    });

    pc2.onIceCandidate((candidate) async {
      print('222 new candidate: ${candidate.sdpMid} ${candidate.sdpMLineIndex} ${candidate.candidate}');
