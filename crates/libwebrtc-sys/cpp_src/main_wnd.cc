...
//   static HFONT font =
//   reinterpret_cast<HFONT>(GetStockObject(DEFAULT_GUI_FONT)); return font;
// }
...
//       LRESULT selection = ::SendMessage(listbox_, LB_SETCURSEL, count - 1,
//       0); if (selection != LB_ERR)
...
// void MainWnd::MessageBox(const char* caption, const char* text, bool
// is_error) {
//   DWORD flags = MB_OK;
//   if (is_error)
//     flags |= MB_ICONERROR;
...
//       HBITMAP bmp_mem = ::CreateCompatibleBitmap(ps.hdc, rc.right,
//       rc.bottom); HGDIOBJ bmp_old = ::SelectObject(dc_mem, bmp_mem);
...
//   *wnd = ::CreateWindowExW(ex_style, class_name, L"", style, 100, 100, 100,
//   100,
...
//   CreateChildWindow(&label1_, LABEL1_ID, L"Static", ES_CENTER | ES_READONLY,
//   0); CreateChildWindow(&edit1_, EDIT_ID, L"Edit",
//                     ES_LEFT | ES_NOHIDESEL | WS_TABSTOP, WS_EX_CLIENTEDGE);
//   CreateChildWindow(&label2_, LABEL2_ID, L"Static", ES_CENTER | ES_READONLY,
//   0); CreateChildWindow(&edit2_, EDIT_ID, L"Edit",
//                     ES_LEFT | ES_NOHIDESEL | WS_TABSTOP, WS_EX_CLIENTEDGE);
//   CreateChildWindow(&button_, BUTTON_ID, L"Button", BS_CENTER | WS_TABSTOP,
//   0);
...
//       ::MoveWindow(windows[i].wnd, static_cast<int>(x),
//       static_cast<int>(top),
