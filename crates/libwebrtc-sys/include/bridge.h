...
// Registers the provided observer in the provided `LocalAudioSource`, so any
// audio level updates will be passes to this observer.
//
...
// Unregisters an audio level observer from the provided `LocalAudioSource`.
//
