...
void set_rtp_encoding_parameters_rid(
    webrtc::RtpEncodingParameters& encoding, rust::String rid) {
...
void set_rtp_encoding_parameters_active(
    webrtc::RtpEncodingParameters& encoding, bool active) {
...
// Returns the `RtpEncodingParameters.maxBitrate` field value.
void set_rtp_encoding_parameters_maxBitrate(
    webrtc::RtpEncodingParameters& encoding, int32_t max_bitrate) {
...
void set_rtp_encoding_parameters_maxFramerate(
...
void set_rtp_encoding_parameters_scale_resolution_down_by(
    webrtc::RtpEncodingParameters& encoding, double scale_resolution_down_by) {
...
void set_rtp_encoding_parameters_scalability_mode(
    webrtc::RtpEncodingParameters& encoding, rust::String scalability_mode) {
