...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -602564949;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        16 => wire__crate__api__get_rtp_sender_capabilities_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__api__get_transceiver_direction_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__api__get_transceiver_mid_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__get_transceivers_impl(port, ptr, rust_vec_len, data_len),
        20 => wire__crate__api__is_fake_media_impl(port, ptr, rust_vec_len, data_len),
        21 => wire__crate__api__microphone_volume_impl(port, ptr, rust_vec_len, data_len),
        22 => {
            wire__crate__api__microphone_volume_is_available_impl(port, ptr, rust_vec_len, data_len)
        }
        23 => wire__crate__api__register_track_observer_impl(port, ptr, rust_vec_len, data_len),
        24 => wire__crate__api__restart_ice_impl(port, ptr, rust_vec_len, data_len),
        25 => wire__crate__api__sender_get_parameters_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__api__sender_replace_track_impl(port, ptr, rust_vec_len, data_len),
        27 => wire__crate__api__sender_set_parameters_impl(port, ptr, rust_vec_len, data_len),
        28 => wire__crate__api__set_audio_level_observer_enabled_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        29 => wire__crate__api__set_audio_playout_device_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__api__set_codec_preferences_impl(port, ptr, rust_vec_len, data_len),
        31 => wire__crate__api__set_local_description_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__api__set_microphone_volume_impl(port, ptr, rust_vec_len, data_len),
        33 => wire__crate__api__set_on_device_changed_impl(port, ptr, rust_vec_len, data_len),
        34 => wire__crate__api__set_remote_description_impl(port, ptr, rust_vec_len, data_len),
        35 => wire__crate__api__set_track_enabled_impl(port, ptr, rust_vec_len, data_len),
        36 => wire__crate__api__set_transceiver_direction_impl(port, ptr, rust_vec_len, data_len),
        37 => wire__crate__api__set_transceiver_recv_impl(port, ptr, rust_vec_len, data_len),
        38 => wire__crate__api__set_transceiver_send_impl(port, ptr, rust_vec_len, data_len),
        39 => wire__crate__api__stop_transceiver_impl(port, ptr, rust_vec_len, data_len),
        40 => wire__crate__api__track_height_impl(port, ptr, rust_vec_len, data_len),
        41 => wire__crate__api__track_state_impl(port, ptr, rust_vec_len, data_len),
        42 => wire__crate__api__track_width_impl(port, ptr, rust_vec_len, data_len),
        43 => wire__crate__api__video_decoders_impl(port, ptr, rust_vec_len, data_len),
        44 => wire__crate__api__video_encoders_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
