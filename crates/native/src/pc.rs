...
use crate::{
    api, api::PeerConnectionEvent, AudioTrack, AudioTrackId, VideoTrack, VideoTrackId,
    Webrtc,
};
...
impl Webrtc {
    ...
    pub fn get_transceiver_direction(
        ...
        let transceiver = if let Some(transceiver) = peer
            .0
            .lock()
            .unwrap()
            .get_transceivers()
        ...
        transceiver.direction().to_string()
    }
