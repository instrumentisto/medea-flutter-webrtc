...
#[no_mangle]
pub extern "C" fn wire_add_transceiver_direction(port_: i64, peer_id: u64, transceiver_index: u32, direction: i32) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "add_transceiver_direction",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            ...
            let api_transceiver_index = transceiver_index.wire2api();
            let api_direction = direction.wire2api();
            move |task_callback| add_transceiver_direction(api_peer_id, api_transceiver_index, api_direction)
        },
    )
}

#[no_mangle]
pub extern "C" fn wire_sub_transceiver_direction(port_: i64, peer_id: u64, transceiver_index: u32, direction: i32) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "sub_transceiver_direction",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            ...
            let api_transceiver_index = transceiver_index.wire2api();
            let api_direction = direction.wire2api();
            move |task_callback| sub_transceiver_direction(api_peer_id, api_transceiver_index, api_direction)
        },
    )
}
    ...
    fn into_dart(self) -> support::DartCObject {
        match self {
            ...
            Self::IceCandidate {
                ...
                sdp_mline_index,
                candidate,
            } => vec![1.into_dart(), sdp_mid.into_dart(), sdp_mline_index.into_dart(), candidate.into_dart()],
