...
fn wire_enable_fake_media_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "enable_fake_media", port: Some(port_), mode: FfiCallMode::Normal }, move || move |task_callback| Ok(enable_fake_media()))
}
fn wire_is_fake_media_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, bool>(WrapInfo { debug_name: "is_fake_media", port: Some(port_), mode: FfiCallMode::Normal }, move || move |task_callback| Ok(is_fake_media()))
}
fn wire_enumerate_devices_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<MediaDeviceInfo>>(WrapInfo { debug_name: "enumerate_devices", port: Some(port_), mode: FfiCallMode::Normal }, move || move |task_callback| enumerate_devices())
}
fn wire_enumerate_displays_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<MediaDisplayInfo>>(WrapInfo { debug_name: "enumerate_displays", port: Some(port_), mode: FfiCallMode::Normal }, move || move |task_callback| Ok(enumerate_displays()))
}
fn wire_create_peer_connection_impl(port_: MessagePort, configuration: impl Wire2Api<RtcConfiguration> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "create_peer_connection", port: Some(port_), mode: FfiCallMode::Stream }, move || {
        let api_configuration = configuration.wire2api();
        move |task_callback| create_peer_connection(task_callback.stream_sink::<_, PeerConnectionEvent>(), api_configuration)
    })
}
fn wire_create_offer_impl(port_: MessagePort, peer: impl Wire2Api<RustOpaque<Arc<PeerConnection>>> + UnwindSafe, voice_activity_detection: impl Wire2Api<bool> + UnwindSafe, ice_restart: impl Wire2Api<bool> + UnwindSafe, use_rtp_mux: impl Wire2Api<bool> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, RtcSessionDescription>(WrapInfo { debug_name: "create_offer", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        ...
        move |task_callback| create_offer(api_peer, api_voice_activity_detection, api_ice_restart, api_use_rtp_mux)
    })
}
fn wire_create_answer_impl(port_: MessagePort, peer: impl Wire2Api<RustOpaque<Arc<PeerConnection>>> + UnwindSafe, voice_activity_detection: impl Wire2Api<bool> + UnwindSafe, ice_restart: impl Wire2Api<bool> + UnwindSafe, use_rtp_mux: impl Wire2Api<bool> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, RtcSessionDescription>(WrapInfo { debug_name: "create_answer", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer = peer.wire2api();
        let api_voice_activity_detection = voice_activity_detection.wire2api();
        let api_ice_restart = ice_restart.wire2api();
        let api_use_rtp_mux = use_rtp_mux.wire2api();
        move |task_callback| create_answer(api_peer, api_voice_activity_detection, api_ice_restart, api_use_rtp_mux)
    })
}
fn wire_set_local_description_impl(port_: MessagePort, peer: impl Wire2Api<RustOpaque<Arc<PeerConnection>>> + UnwindSafe, kind: impl Wire2Api<SdpType> + UnwindSafe, sdp: impl Wire2Api<String> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "set_local_description", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer = peer.wire2api();
...
fn wire_set_remote_description_impl(port_: MessagePort, peer: impl Wire2Api<RustOpaque<Arc<PeerConnection>>> + UnwindSafe, kind: impl Wire2Api<SdpType> + UnwindSafe, sdp: impl Wire2Api<String> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "set_remote_description", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer = peer.wire2api();
        let api_kind = kind.wire2api();
        let api_sdp = sdp.wire2api();
...
fn wire_add_transceiver_impl(port_: MessagePort, peer: impl Wire2Api<RustOpaque<Arc<PeerConnection>>> + UnwindSafe, media_type: impl Wire2Api<MediaType> + UnwindSafe, init: impl Wire2Api<RtpTransceiverInit> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, RtcRtpTransceiver>(WrapInfo { debug_name: "add_transceiver", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer = peer.wire2api();
...
fn wire_get_transceivers_impl(port_: MessagePort, peer: impl Wire2Api<RustOpaque<Arc<PeerConnection>>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<RtcRtpTransceiver>>(WrapInfo { debug_name: "get_transceivers", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer = peer.wire2api();
        move |task_callback| Ok(get_transceivers(api_peer))
    })
}
fn wire_set_transceiver_direction_impl(port_: MessagePort, transceiver: impl Wire2Api<RustOpaque<Arc<RtpTransceiver>>> + UnwindSafe, direction: impl Wire2Api<RtpTransceiverDirection> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "set_transceiver_direction", port: Some(port_), mode: FfiCallMode::Normal }, move || {
...
fn wire_set_transceiver_recv_impl(port_: MessagePort, transceiver: impl Wire2Api<RustOpaque<Arc<RtpTransceiver>>> + UnwindSafe, recv: impl Wire2Api<bool> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "set_transceiver_recv", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_transceiver = transceiver.wire2api();
        let api_recv = recv.wire2api();
        move |task_callback| set_transceiver_recv(api_transceiver, api_recv)
    })
}
fn wire_set_transceiver_send_impl(port_: MessagePort, transceiver: impl Wire2Api<RustOpaque<Arc<RtpTransceiver>>> + UnwindSafe, send: impl Wire2Api<bool> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "set_transceiver_send", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_transceiver = transceiver.wire2api();
        let api_send = send.wire2api();
        move |task_callback| set_transceiver_send(api_transceiver, api_send)
    })
}
fn wire_get_transceiver_mid_impl(port_: MessagePort, transceiver: impl Wire2Api<RustOpaque<Arc<RtpTransceiver>>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Option<String>>(WrapInfo { debug_name: "get_transceiver_mid", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_transceiver = transceiver.wire2api();
        move |task_callback| Ok(get_transceiver_mid(api_transceiver))
    })
}
fn wire_get_transceiver_direction_impl(port_: MessagePort, transceiver: impl Wire2Api<RustOpaque<Arc<RtpTransceiver>>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, RtpTransceiverDirection>(WrapInfo { debug_name: "get_transceiver_direction", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_transceiver = transceiver.wire2api();
        move |task_callback| Ok(get_transceiver_direction(api_transceiver))
    })
}
fn wire_get_peer_stats_impl(port_: MessagePort, peer: impl Wire2Api<RustOpaque<Arc<PeerConnection>>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<RtcStats>>(WrapInfo { debug_name: "get_peer_stats", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer = peer.wire2api();
        move |task_callback| get_peer_stats(api_peer)
    })
}
fn wire_stop_transceiver_impl(port_: MessagePort, transceiver: impl Wire2Api<RustOpaque<Arc<RtpTransceiver>>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "stop_transceiver", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_transceiver = transceiver.wire2api();
        move |task_callback| stop_transceiver(api_transceiver)
    })
}
fn wire_sender_replace_track_impl(port_: MessagePort, peer: impl Wire2Api<RustOpaque<Arc<PeerConnection>>> + UnwindSafe, transceiver: impl Wire2Api<RustOpaque<Arc<RtpTransceiver>>> + UnwindSafe, track_id: impl Wire2Api<Option<String>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "sender_replace_track", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer = peer.wire2api();
        let api_transceiver = transceiver.wire2api();
...
fn wire_sender_get_parameters_impl(port_: MessagePort, transceiver: impl Wire2Api<RustOpaque<Arc<RtpTransceiver>>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, RtcRtpSendParameters>(WrapInfo { debug_name: "sender_get_parameters", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_transceiver = transceiver.wire2api();
        move |task_callback| Ok(sender_get_parameters(api_transceiver))
    })
}
fn wire_sender_set_parameters_impl(port_: MessagePort, transceiver: impl Wire2Api<RustOpaque<Arc<RtpTransceiver>>> + UnwindSafe, params: impl Wire2Api<RtcRtpSendParameters> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "sender_set_parameters", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_transceiver = transceiver.wire2api();
        let api_params = params.wire2api();
        move |task_callback| sender_set_parameters(api_transceiver, api_params)
    })
}
fn wire_add_ice_candidate_impl(port_: MessagePort, peer: impl Wire2Api<RustOpaque<Arc<PeerConnection>>> + UnwindSafe, candidate: impl Wire2Api<String> + UnwindSafe, sdp_mid: impl Wire2Api<String> + UnwindSafe, sdp_mline_index: impl Wire2Api<i32> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "add_ice_candidate", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer = peer.wire2api();
        let api_candidate = candidate.wire2api();
        let api_sdp_mid = sdp_mid.wire2api();
        let api_sdp_mline_index = sdp_mline_index.wire2api();
        move |task_callback| add_ice_candidate(api_peer, api_candidate, api_sdp_mid, api_sdp_mline_index)
    })
}
fn wire_restart_ice_impl(port_: MessagePort, peer: impl Wire2Api<RustOpaque<Arc<PeerConnection>>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "restart_ice", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer = peer.wire2api();
        move |task_callback| Ok(restart_ice(api_peer))
    })
}
fn wire_dispose_peer_connection_impl(port_: MessagePort, peer: impl Wire2Api<RustOpaque<Arc<PeerConnection>>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "dispose_peer_connection", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer = peer.wire2api();
        move |task_callback| Ok(dispose_peer_connection(api_peer))
    })
}
fn wire_get_media_impl(port_: MessagePort, constraints: impl Wire2Api<MediaStreamConstraints> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, GetMediaResult>(WrapInfo { debug_name: "get_media", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_constraints = constraints.wire2api();
        move |task_callback| Ok(get_media(api_constraints))
    })
}
fn wire_set_audio_playout_device_impl(port_: MessagePort, device_id: impl Wire2Api<String> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "set_audio_playout_device", port: Some(port_), mode: FfiCallMode::Normal }, move || {
...
fn wire_microphone_volume_is_available_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, bool>(WrapInfo { debug_name: "microphone_volume_is_available", port: Some(port_), mode: FfiCallMode::Normal }, move || move |task_callback| microphone_volume_is_available())
}
fn wire_set_microphone_volume_impl(port_: MessagePort, level: impl Wire2Api<u8> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "set_microphone_volume", port: Some(port_), mode: FfiCallMode::Normal }, move || {
...
fn wire_microphone_volume_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, u32>(WrapInfo { debug_name: "microphone_volume", port: Some(port_), mode: FfiCallMode::Normal }, move || move |task_callback| microphone_volume())
}
fn wire_dispose_track_impl(port_: MessagePort, track_id: impl Wire2Api<String> + UnwindSafe, peer_id: impl Wire2Api<Option<u64>> + UnwindSafe, kind: impl Wire2Api<MediaType> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "dispose_track", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_track_id = track_id.wire2api();
        let api_peer_id = peer_id.wire2api();
        let api_kind = kind.wire2api();
        move |task_callback| Ok(dispose_track(api_track_id, api_peer_id, api_kind))
    })
}
fn wire_track_state_impl(port_: MessagePort, track_id: impl Wire2Api<String> + UnwindSafe, peer_id: impl Wire2Api<Option<u64>> + UnwindSafe, kind: impl Wire2Api<MediaType> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, TrackState>(WrapInfo { debug_name: "track_state", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_track_id = track_id.wire2api();
        let api_peer_id = peer_id.wire2api();
        let api_kind = kind.wire2api();
...
fn wire_set_track_enabled_impl(port_: MessagePort, track_id: impl Wire2Api<String> + UnwindSafe, peer_id: impl Wire2Api<Option<u64>> + UnwindSafe, kind: impl Wire2Api<MediaType> + UnwindSafe, enabled: impl Wire2Api<bool> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "set_track_enabled", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_track_id = track_id.wire2api();
        let api_peer_id = peer_id.wire2api();
        let api_kind = kind.wire2api();
...
fn wire_clone_track_impl(port_: MessagePort, track_id: impl Wire2Api<String> + UnwindSafe, peer_id: impl Wire2Api<Option<u64>> + UnwindSafe, kind: impl Wire2Api<MediaType> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, MediaStreamTrack>(WrapInfo { debug_name: "clone_track", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_track_id = track_id.wire2api();
        let api_peer_id = peer_id.wire2api();
        let api_kind = kind.wire2api();
...
fn wire_register_track_observer_impl(port_: MessagePort, peer_id: impl Wire2Api<Option<u64>> + UnwindSafe, track_id: impl Wire2Api<String> + UnwindSafe, kind: impl Wire2Api<MediaType> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "register_track_observer", port: Some(port_), mode: FfiCallMode::Stream }, move || {
        let api_peer_id = peer_id.wire2api();
        let api_track_id = track_id.wire2api();
        let api_kind = kind.wire2api();
        move |task_callback| register_track_observer(task_callback.stream_sink::<_, TrackEvent>(), api_peer_id, api_track_id, api_kind)
    })
}
fn wire_set_on_device_changed_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "set_on_device_changed", port: Some(port_), mode: FfiCallMode::Stream }, move || move |task_callback| set_on_device_changed(task_callback.stream_sink::<_, ()>()))
}
fn wire_create_video_sink_impl(port_: MessagePort, sink_id: impl Wire2Api<i64> + UnwindSafe, peer_id: impl Wire2Api<Option<u64>> + UnwindSafe, track_id: impl Wire2Api<String> + UnwindSafe, callback_ptr: impl Wire2Api<u64> + UnwindSafe, texture_id: impl Wire2Api<i64> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "create_video_sink", port: Some(port_), mode: FfiCallMode::Stream }, move || {
        let api_sink_id = sink_id.wire2api();
        let api_peer_id = peer_id.wire2api();
        let api_track_id = track_id.wire2api();
        let api_callback_ptr = callback_ptr.wire2api();
        let api_texture_id = texture_id.wire2api();
        move |task_callback| create_video_sink(task_callback.stream_sink::<_, TextureEvent>(), api_sink_id, api_peer_id, api_track_id, api_callback_ptr, api_texture_id)
    })
}
fn wire_dispose_video_sink_impl(port_: MessagePort, sink_id: impl Wire2Api<i64> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(WrapInfo { debug_name: "dispose_video_sink", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_sink_id = sink_id.wire2api();
...
impl support::IntoDart for IceCandidateStats {
    fn into_dart(self) -> support::DartAbi {
        vec![self.transport_id.into_dart(), self.address.into_dart(), self.port.into_dart(), self.protocol.into_into_dart().into_dart(), self.candidate_type.into_into_dart().into_dart(), self.priority.into_dart(), self.url.into_dart(), self.relay_protocol.into_dart()].into_dart()
    }
}
...
impl support::IntoDart for MediaDeviceInfo {
    fn into_dart(self) -> support::DartAbi {
        vec![self.device_id.into_into_dart().into_dart(), self.kind.into_into_dart().into_dart(), self.label.into_into_dart().into_dart()].into_dart()
    }
}
...
impl support::IntoDart for MediaDisplayInfo {
    fn into_dart(self) -> support::DartAbi {
        vec![self.device_id.into_into_dart().into_dart(), self.title.into_dart()].into_dart()
    }
}
...
impl support::IntoDart for MediaStreamTrack {
    fn into_dart(self) -> support::DartAbi {
        vec![self.id.into_into_dart().into_dart(), self.peer_id.into_dart(), self.device_id.into_into_dart().into_dart(), self.kind.into_into_dart().into_dart(), self.enabled.into_into_dart().into_dart()].into_dart()
    }
}
...
impl support::IntoDart for PeerConnectionEvent {
    fn into_dart(self) -> support::DartAbi {
        match self {
            ...
            Self::IceCandidate { sdp_mid, sdp_mline_index, candidate } => vec![1.into_dart(), sdp_mid.into_into_dart().into_dart(), sdp_mline_index.into_into_dart().into_dart(), candidate.into_into_dart().into_dart()],
            Self::IceGatheringStateChange(field0) => vec![2.into_dart(), field0.into_into_dart().into_dart()],
            Self::IceCandidateError { address, port, url, error_code, error_text } => vec![3.into_dart(), address.into_into_dart().into_dart(), port.into_into_dart().into_dart(), url.into_into_dart().into_dart(), error_code.into_into_dart().into_dart(), error_text.into_into_dart().into_dart()],
            Self::NegotiationNeeded => vec![4.into_dart()],
            Self::SignallingChange(field0) => vec![5.into_dart(), field0.into_into_dart().into_dart()],
            Self::IceConnectionStateChange(field0) => vec![6.into_dart(), field0.into_into_dart().into_dart()],
            Self::ConnectionStateChange(field0) => vec![7.into_dart(), field0.into_into_dart().into_dart()],
...
impl support::IntoDart for RtcInboundRtpStreamMediaType {
    fn into_dart(self) -> support::DartAbi {
        match self {
            Self::Audio { voice_activity_flag, total_samples_received, concealed_samples, silent_concealed_samples, audio_level, total_audio_energy, total_samples_duration } => vec![0.into_dart(), voice_activity_flag.into_dart(), total_samples_received.into_dart(), concealed_samples.into_dart(), silent_concealed_samples.into_dart(), audio_level.into_dart(), total_audio_energy.into_dart(), total_samples_duration.into_dart()],
            Self::Video { frames_decoded, key_frames_decoded, frame_width, frame_height, total_inter_frame_delay, frames_per_second, fir_count, pli_count, sli_count, concealment_events, frames_received } => vec![1.into_dart(), frames_decoded.into_dart(), key_frames_decoded.into_dart(), frame_width.into_dart(), frame_height.into_dart(), total_inter_frame_delay.into_dart(), frames_per_second.into_dart(), fir_count.into_dart(), pli_count.into_dart(), sli_count.into_dart(), concealment_events.into_dart(), frames_received.into_dart()],
        }
        .into_dart()
    }
}
...
impl support::IntoDart for RtcMediaSourceStatsMediaType {
    fn into_dart(self) -> support::DartAbi {
        match self {
            Self::RtcVideoSourceStats { width, height, frames, frames_per_second } => vec![0.into_dart(), width.into_dart(), height.into_dart(), frames.into_dart(), frames_per_second.into_dart()],
            Self::RtcAudioSourceStats { audio_level, total_audio_energy, total_samples_duration, echo_return_loss, echo_return_loss_enhancement } => vec![1.into_dart(), audio_level.into_dart(), total_audio_energy.into_dart(), total_samples_duration.into_dart(), echo_return_loss.into_dart(), echo_return_loss_enhancement.into_dart()],
        }
        .into_dart()
    }
}
...
impl support::IntoDart for RtcOutboundRtpStreamStatsMediaType {
    fn into_dart(self) -> support::DartAbi {
        match self {
            Self::Audio { total_samples_sent, voice_activity_flag } => vec![0.into_dart(), total_samples_sent.into_dart(), voice_activity_flag.into_dart()],
            Self::Video { frame_width, frame_height, frames_per_second } => vec![1.into_dart(), frame_width.into_dart(), frame_height.into_dart(), frames_per_second.into_dart()],
        }
        .into_dart()
    }
}
impl support::IntoDartExceptPrimitive for RtcOutboundRtpStreamStatsMediaType {}
impl rust2dart::IntoIntoDart<RtcOutboundRtpStreamStatsMediaType> for RtcOutboundRtpStreamStatsMediaType {
    fn into_into_dart(self) -> Self {
        self
    }
}
...
impl support::IntoDart for RtcRtpEncodingParameters {
    fn into_dart(self) -> support::DartAbi {
        vec![self.rid.into_into_dart().into_dart(), self.active.into_into_dart().into_dart(), self.max_bitrate.into_dart(), self.max_framerate.into_dart(), self.scale_resolution_down_by.into_dart(), self.scalability_mode.into_dart()].into_dart()
    }
}
...
impl support::IntoDart for RtcRtpSendParameters {
    fn into_dart(self) -> support::DartAbi {
        vec![self.encodings.into_into_dart().into_dart(), self.inner.into_dart()].into_dart()
    }
}
...
impl support::IntoDart for RtcRtpTransceiver {
    fn into_dart(self) -> support::DartAbi {
        vec![self.peer.into_dart(), self.transceiver.into_dart(), self.mid.into_dart(), self.direction.into_into_dart().into_dart()].into_dart()
    }
}
...
impl support::IntoDart for RtcSessionDescription {
    fn into_dart(self) -> support::DartAbi {
        vec![self.sdp.into_into_dart().into_dart(), self.kind.into_into_dart().into_dart()].into_dart()
    }
}
...
impl support::IntoDart for RtcStats {
    fn into_dart(self) -> support::DartAbi {
        vec![self.id.into_into_dart().into_dart(), self.timestamp_us.into_into_dart().into_dart(), self.kind.into_into_dart().into_dart()].into_dart()
    }
}
...
impl support::IntoDart for RtcStatsType {
    fn into_dart(self) -> support::DartAbi {
        match self {
            Self::RtcMediaSourceStats { track_identifier, kind } => vec![0.into_dart(), track_identifier.into_dart(), kind.into_into_dart().into_dart()],
            Self::RtcIceCandidateStats(field0) => vec![1.into_dart(), field0.into_into_dart().into_dart()],
            Self::RtcOutboundRtpStreamStats { track_id, media_type, bytes_sent, packets_sent, media_source_id } => vec![2.into_dart(), track_id.into_dart(), media_type.into_into_dart().into_dart(), bytes_sent.into_dart(), packets_sent.into_dart(), media_source_id.into_dart()],
            Self::RtcInboundRtpStreamStats { remote_id, bytes_received, packets_received, packets_lost, jitter, total_decode_time, jitter_buffer_emitted_count, media_type } => vec![3.into_dart(), remote_id.into_dart(), bytes_received.into_dart(), packets_received.into_dart(), packets_lost.into_dart(), jitter.into_dart(), total_decode_time.into_dart(), jitter_buffer_emitted_count.into_dart(), media_type.into_dart()],
            Self::RtcIceCandidatePairStats { state, nominated, bytes_sent, bytes_received, total_round_trip_time, current_round_trip_time, available_outgoing_bitrate } => vec![4.into_dart(), state.into_into_dart().into_dart(), nominated.into_dart(), bytes_sent.into_dart(), bytes_received.into_dart(), total_round_trip_time.into_dart(), current_round_trip_time.into_dart(), available_outgoing_bitrate.into_dart()],
            Self::RtcTransportStats { packets_sent, packets_received, bytes_sent, bytes_received, ice_role } => vec![5.into_dart(), packets_sent.into_dart(), packets_received.into_dart(), bytes_sent.into_dart(), bytes_received.into_dart(), ice_role.into_dart()],
            Self::RtcRemoteInboundRtpStreamStats { local_id, jitter, round_trip_time, fraction_lost, reports_received, round_trip_time_measurements } => vec![6.into_dart(), local_id.into_dart(), jitter.into_dart(), round_trip_time.into_dart(), fraction_lost.into_dart(), reports_received.into_dart(), round_trip_time_measurements.into_dart()],
            Self::RtcRemoteOutboundRtpStreamStats { local_id, remote_timestamp, reports_sent } => vec![7.into_dart(), local_id.into_dart(), remote_timestamp.into_dart(), reports_sent.into_dart()],
...
impl support::IntoDart for RtcTrackEvent {
    fn into_dart(self) -> support::DartAbi {
        vec![self.track.into_into_dart().into_dart(), self.transceiver.into_into_dart().into_dart()].into_dart()
    }
}
...
impl support::IntoDart for TextureEvent {
    fn into_dart(self) -> support::DartAbi {
        match self {
            Self::OnTextureChange { texture_id, width, height, rotation } => vec![0.into_dart(), texture_id.into_into_dart().into_dart(), width.into_into_dart().into_dart(), height.into_into_dart().into_dart(), rotation.into_into_dart().into_dart()],
            Self::OnFirstFrameRendered { texture_id } => vec![1.into_dart(), texture_id.into_into_dart().into_dart()],
        }
        .into_dart()
    }
}
...
mod io {
    ...
    #[no_mangle]
    pub extern "C" fn wire_create_offer(port_: i64, peer: wire_ArcPeerConnection, voice_activity_detection: bool, ice_restart: bool, use_rtp_mux: bool) {
        wire_create_offer_impl(port_, peer, voice_activity_detection, ice_restart, use_rtp_mux)
    }

    #[no_mangle]
    pub extern "C" fn wire_create_answer(port_: i64, peer: wire_ArcPeerConnection, voice_activity_detection: bool, ice_restart: bool, use_rtp_mux: bool) {
        wire_create_answer_impl(port_, peer, voice_activity_detection, ice_restart, use_rtp_mux)
    }

    #[no_mangle]
    pub extern "C" fn wire_set_local_description(port_: i64, peer: wire_ArcPeerConnection, kind: i32, sdp: *mut wire_uint_8_list) {
        wire_set_local_description_impl(port_, peer, kind, sdp)
    }

    #[no_mangle]
    pub extern "C" fn wire_set_remote_description(port_: i64, peer: wire_ArcPeerConnection, kind: i32, sdp: *mut wire_uint_8_list) {
        wire_set_remote_description_impl(port_, peer, kind, sdp)
    }

    #[no_mangle]
    pub extern "C" fn wire_add_transceiver(port_: i64, peer: wire_ArcPeerConnection, media_type: i32, init: *mut wire_RtpTransceiverInit) {
    ...
    #[no_mangle]
    pub extern "C" fn wire_set_transceiver_direction(port_: i64, transceiver: wire_ArcRtpTransceiver, direction: i32) {
        wire_set_transceiver_direction_impl(port_, transceiver, direction)
    }

    #[no_mangle]
    pub extern "C" fn wire_set_transceiver_recv(port_: i64, transceiver: wire_ArcRtpTransceiver, recv: bool) {
        wire_set_transceiver_recv_impl(port_, transceiver, recv)
    }

    #[no_mangle]
    pub extern "C" fn wire_set_transceiver_send(port_: i64, transceiver: wire_ArcRtpTransceiver, send: bool) {
    ...
    #[no_mangle]
    pub extern "C" fn wire_get_transceiver_direction(port_: i64, transceiver: wire_ArcRtpTransceiver) {
    ...
    #[no_mangle]
    pub extern "C" fn wire_sender_replace_track(port_: i64, peer: wire_ArcPeerConnection, transceiver: wire_ArcRtpTransceiver, track_id: *mut wire_uint_8_list) {
    ...
    #[no_mangle]
    pub extern "C" fn wire_sender_set_parameters(port_: i64, transceiver: wire_ArcRtpTransceiver, params: *mut wire_RtcRtpSendParameters) {
        wire_sender_set_parameters_impl(port_, transceiver, params)
    }

    #[no_mangle]
    pub extern "C" fn wire_add_ice_candidate(port_: i64, peer: wire_ArcPeerConnection, candidate: *mut wire_uint_8_list, sdp_mid: *mut wire_uint_8_list, sdp_mline_index: i32) {
    ...
    #[no_mangle]
    pub extern "C" fn wire_dispose_track(port_: i64, track_id: *mut wire_uint_8_list, peer_id: *mut u64, kind: i32) {
        wire_dispose_track_impl(port_, track_id, peer_id, kind)
    }

    #[no_mangle]
    pub extern "C" fn wire_track_state(port_: i64, track_id: *mut wire_uint_8_list, peer_id: *mut u64, kind: i32) {
        wire_track_state_impl(port_, track_id, peer_id, kind)
    }

    #[no_mangle]
    pub extern "C" fn wire_set_track_enabled(port_: i64, track_id: *mut wire_uint_8_list, peer_id: *mut u64, kind: i32, enabled: bool) {
        wire_set_track_enabled_impl(port_, track_id, peer_id, kind, enabled)
    }

    #[no_mangle]
    pub extern "C" fn wire_clone_track(port_: i64, track_id: *mut wire_uint_8_list, peer_id: *mut u64, kind: i32) {
        wire_clone_track_impl(port_, track_id, peer_id, kind)
    }

    #[no_mangle]
    pub extern "C" fn wire_register_track_observer(port_: i64, peer_id: *mut u64, track_id: *mut wire_uint_8_list, kind: i32) {
    ...
    #[no_mangle]
    pub extern "C" fn wire_create_video_sink(port_: i64, sink_id: i64, peer_id: *mut u64, track_id: *mut wire_uint_8_list, callback_ptr: u64, texture_id: i64) {
    ...
    #[no_mangle]
    pub extern "C" fn new_list___record__rtc_rtp_encoding_parameters_ArcRtpEncodingParameters_0(len: i32) -> *mut wire_list___record__rtc_rtp_encoding_parameters_ArcRtpEncodingParameters {
    ...
    #[no_mangle]
    pub extern "C" fn new_list_rtc_rtp_encoding_parameters_0(len: i32) -> *mut wire_list_rtc_rtp_encoding_parameters {
        let wrap = wire_list_rtc_rtp_encoding_parameters { ptr: support::new_leak_vec_ptr(<wire_RtcRtpEncodingParameters>::new_with_null_ptr(), len), len };
        support::new_leak_box_ptr(wrap)
    }
    ...
    impl Wire2Api<(RtcRtpEncodingParameters, RustOpaque<Arc<RtpEncodingParameters>>)> for wire___record__rtc_rtp_encoding_parameters_ArcRtpEncodingParameters {
        fn wire2api(self) -> (RtcRtpEncodingParameters, RustOpaque<Arc<RtpEncodingParameters>>) {
    ...
    impl Wire2Api<AudioConstraints> for wire_AudioConstraints {
        fn wire2api(self) -> AudioConstraints {
            AudioConstraints { device_id: self.device_id.wire2api() }
        }
    }
    ...
    impl Wire2Api<Vec<(RtcRtpEncodingParameters, RustOpaque<Arc<RtpEncodingParameters>>)>> for *mut wire_list___record__rtc_rtp_encoding_parameters_ArcRtpEncodingParameters {
        fn wire2api(self) -> Vec<(RtcRtpEncodingParameters, RustOpaque<Arc<RtpEncodingParameters>>)> {
            let vec = unsafe {
                let wrap = support::box_from_leak_ptr(self);
                support::vec_from_leak_ptr(wrap.ptr, wrap.len)
            };
    ...
    impl Wire2Api<RtcConfiguration> for wire_RtcConfiguration {
        fn wire2api(self) -> RtcConfiguration {
            RtcConfiguration { ice_transport_policy: self.ice_transport_policy.wire2api(), bundle_policy: self.bundle_policy.wire2api(), ice_servers: self.ice_servers.wire2api() }
        }
    }
    ...
    impl Wire2Api<RtcRtpEncodingParameters> for wire_RtcRtpEncodingParameters {
        fn wire2api(self) -> RtcRtpEncodingParameters {
            RtcRtpEncodingParameters { rid: self.rid.wire2api(), active: self.active.wire2api(), max_bitrate: self.max_bitrate.wire2api(), max_framerate: self.max_framerate.wire2api(), scale_resolution_down_by: self.scale_resolution_down_by.wire2api(), scalability_mode: self.scalability_mode.wire2api() }
        }
    }
    impl Wire2Api<RtcRtpSendParameters> for wire_RtcRtpSendParameters {
        fn wire2api(self) -> RtcRtpSendParameters {
            RtcRtpSendParameters { encodings: self.encodings.wire2api(), inner: self.inner.wire2api() }
        }
    }

    impl Wire2Api<RtpTransceiverInit> for wire_RtpTransceiverInit {
        fn wire2api(self) -> RtpTransceiverInit {
            RtpTransceiverInit { direction: self.direction.wire2api(), send_encodings: self.send_encodings.wire2api() }
        }
    }
    ...
    impl Wire2Api<VideoConstraints> for wire_VideoConstraints {
        fn wire2api(self) -> VideoConstraints {
            VideoConstraints { device_id: self.device_id.wire2api(), width: self.width.wire2api(), height: self.height.wire2api(), frame_rate: self.frame_rate.wire2api(), is_display: self.is_display.wire2api() }
        }
    }
    ...
    impl NewWithNullPtr for wire___record__rtc_rtp_encoding_parameters_ArcRtpEncodingParameters {
        fn new_with_null_ptr() -> Self {
            Self { field0: Default::default(), field1: wire_ArcRtpEncodingParameters::new_with_null_ptr() }
        }
    }
    ...
    impl NewWithNullPtr for wire_AudioConstraints {
        fn new_with_null_ptr() -> Self {
            Self { device_id: core::ptr::null_mut() }
        }
    }
    ...
    impl NewWithNullPtr for wire_RtcRtpEncodingParameters {
        fn new_with_null_ptr() -> Self {
            Self { rid: core::ptr::null_mut(), active: Default::default(), max_bitrate: core::ptr::null_mut(), max_framerate: core::ptr::null_mut(), scale_resolution_down_by: core::ptr::null_mut(), scalability_mode: core::ptr::null_mut() }
        }
    }
    ...
    impl NewWithNullPtr for wire_RtcRtpSendParameters {
        fn new_with_null_ptr() -> Self {
            Self { encodings: core::ptr::null_mut(), inner: wire_ArcRtpParameters::new_with_null_ptr() }
        }
    }
    ...
    impl NewWithNullPtr for wire_RtpTransceiverInit {
        fn new_with_null_ptr() -> Self {
            Self { direction: Default::default(), send_encodings: core::ptr::null_mut() }
        }
    }
    ...
    impl NewWithNullPtr for wire_VideoConstraints {
        fn new_with_null_ptr() -> Self {
            Self { device_id: core::ptr::null_mut(), width: Default::default(), height: Default::default(), frame_rate: Default::default(), is_display: Default::default() }
        }
    }
