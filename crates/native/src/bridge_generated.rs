...
pub extern "C" fn wire_enumerate_devices(port_: i64) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "enumerate_devices", port: Some(port_), mode: FfiCallMode::Normal }, move || move |task_callback| enumerate_devices())
}

#[no_mangle]
pub extern "C" fn wire_create_peer_connection(port_: i64, configuration: *mut wire_RtcConfiguration) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "create_peer_connection", port: Some(port_), mode: FfiCallMode::Stream }, move || {
        let api_configuration = configuration.wire2api();
        move |task_callback| create_peer_connection(task_callback.stream_sink(), api_configuration)
    })
}

#[no_mangle]
pub extern "C" fn wire_create_offer(port_: i64, peer_id: u64, voice_activity_detection: bool, ice_restart: bool, use_rtp_mux: bool) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "create_offer", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        ...
        move |task_callback| create_offer(api_peer_id, api_voice_activity_detection, api_ice_restart, api_use_rtp_mux)
    })
}

#[no_mangle]
pub extern "C" fn wire_create_answer(port_: i64, peer_id: u64, voice_activity_detection: bool, ice_restart: bool, use_rtp_mux: bool) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "create_answer", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer_id = peer_id.wire2api();
        let api_voice_activity_detection = voice_activity_detection.wire2api();
        let api_ice_restart = ice_restart.wire2api();
        let api_use_rtp_mux = use_rtp_mux.wire2api();
        move |task_callback| create_answer(api_peer_id, api_voice_activity_detection, api_ice_restart, api_use_rtp_mux)
    })
}

#[no_mangle]
pub extern "C" fn wire_set_local_description(port_: i64, peer_id: u64, kind: i32, sdp: *mut wire_uint_8_list) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "set_local_description", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer_id = peer_id.wire2api();
...
pub extern "C" fn wire_set_remote_description(port_: i64, peer_id: u64, kind: i32, sdp: *mut wire_uint_8_list) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "set_remote_description", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer_id = peer_id.wire2api();
        let api_kind = kind.wire2api();
        let api_sdp = sdp.wire2api();
...
pub extern "C" fn wire_add_transceiver(port_: i64, peer_id: u64, media_type: i32, direction: i32) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "add_transceiver", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer_id = peer_id.wire2api();
...
pub extern "C" fn wire_get_transceivers(port_: i64, peer_id: u64) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "get_transceivers", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer_id = peer_id.wire2api();
...
pub extern "C" fn wire_get_transceiver_mid(port_: i64, peer_id: u64, transceiver_index: u32) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "get_transceiver_mid", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer_id = peer_id.wire2api();
        let api_transceiver_index = transceiver_index.wire2api();
...
pub extern "C" fn wire_get_transceiver_direction(port_: i64, peer_id: u64, transceiver_index: u32) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "get_transceiver_direction", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer_id = peer_id.wire2api();
        let api_transceiver_index = transceiver_index.wire2api();
...
pub extern "C" fn wire_stop_transceiver(port_: i64, peer_id: u64, transceiver_index: u32) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "stop_transceiver", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer_id = peer_id.wire2api();
        let api_transceiver_index = transceiver_index.wire2api();
...
pub extern "C" fn wire_sender_replace_track(port_: i64, peer_id: u64, transceiver_index: u32, track_id: *mut wire_uint_8_list) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "sender_replace_track", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer_id = peer_id.wire2api();
        let api_transceiver_index = transceiver_index.wire2api();
        let api_track_id = track_id.wire2api();
        move |task_callback| sender_replace_track(api_peer_id, api_transceiver_index, api_track_id)
    })
}
...
pub extern "C" fn wire_add_ice_candidate(port_: i64, peer_id: u64, candidate: *mut wire_uint_8_list, sdp_mid: *mut wire_uint_8_list, sdp_mline_index: i32) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "add_ice_candidate", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer_id = peer_id.wire2api();
        let api_candidate = candidate.wire2api();
        let api_sdp_mid = sdp_mid.wire2api();
        let api_sdp_mline_index = sdp_mline_index.wire2api();
        move |task_callback| add_ice_candidate(api_peer_id, api_candidate, api_sdp_mid, api_sdp_mline_index)
    })
}

#[no_mangle]
pub extern "C" fn wire_restart_ice(port_: i64, peer_id: u64) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "restart_ice", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer_id = peer_id.wire2api();
...
pub extern "C" fn wire_dispose_peer_connection(port_: i64, peer_id: u64) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "dispose_peer_connection", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_peer_id = peer_id.wire2api();
...
pub extern "C" fn wire_get_media(port_: i64, constraints: *mut wire_MediaStreamConstraints) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "get_media", port: Some(port_), mode: FfiCallMode::Normal }, move || {
...
pub extern "C" fn wire_set_audio_playout_device(port_: i64, device_id: *mut wire_uint_8_list) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "set_audio_playout_device", port: Some(port_), mode: FfiCallMode::Normal }, move || {
...
pub extern "C" fn wire_microphone_volume_is_available(port_: i64) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "microphone_volume_is_available", port: Some(port_), mode: FfiCallMode::Normal }, move || move |task_callback| microphone_volume_is_available())
}

#[no_mangle]
pub extern "C" fn wire_set_microphone_volume(port_: i64, level: u8) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "set_microphone_volume", port: Some(port_), mode: FfiCallMode::Normal }, move || {
...
pub extern "C" fn wire_microphone_volume(port_: i64) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "microphone_volume", port: Some(port_), mode: FfiCallMode::Normal }, move || move |task_callback| microphone_volume())
}

#[no_mangle]
pub extern "C" fn wire_dispose_track(port_: i64, track_id: *mut wire_uint_8_list, kind: i32) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "dispose_track", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_track_id = track_id.wire2api();
        let api_kind = kind.wire2api();
...
pub extern "C" fn wire_track_state(port_: i64, track_id: *mut wire_uint_8_list, kind: i32) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "track_state", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_track_id = track_id.wire2api();
        let api_kind = kind.wire2api();
...
pub extern "C" fn wire_set_track_enabled(port_: i64, track_id: *mut wire_uint_8_list, kind: i32, enabled: bool) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "set_track_enabled", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_track_id = track_id.wire2api();
        let api_kind = kind.wire2api();
...
pub extern "C" fn wire_clone_track(port_: i64, track_id: *mut wire_uint_8_list, kind: i32) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "clone_track", port: Some(port_), mode: FfiCallMode::Normal }, move || {
        let api_track_id = track_id.wire2api();
        let api_kind = kind.wire2api();
...
pub extern "C" fn wire_register_track_observer(port_: i64, track_id: *mut wire_uint_8_list, kind: i32) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "register_track_observer", port: Some(port_), mode: FfiCallMode::Stream }, move || {
        let api_track_id = track_id.wire2api();
        let api_kind = kind.wire2api();
        move |task_callback| register_track_observer(task_callback.stream_sink(), api_track_id, api_kind)
    })
}

#[no_mangle]
pub extern "C" fn wire_set_on_device_changed(port_: i64) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "set_on_device_changed", port: Some(port_), mode: FfiCallMode::Stream }, move || move |task_callback| set_on_device_changed(task_callback.stream_sink()))
}

#[no_mangle]
pub extern "C" fn wire_create_video_sink(port_: i64, sink_id: i64, track_id: *mut wire_uint_8_list, callback_ptr: u64) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo { debug_name: "create_video_sink", port: Some(port_), mode: FfiCallMode::Normal }, move || {
...
pub extern "C" fn wire_dispose_video_sink(sink_id: i64) -> support::WireSyncReturnStruct {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(WrapInfo { debug_name: "dispose_video_sink", port: None, mode: FfiCallMode::Sync }, move || {
        let api_sink_id = sink_id.wire2api();
...
impl support::IntoDart for MediaDeviceInfo {
    fn into_dart(self) -> support::DartCObject {
        vec![self.device_id.into_dart(), self.kind.into_dart(), self.label.into_dart()].into_dart()
    }
}
...
impl support::IntoDart for MediaStreamTrack {
    fn into_dart(self) -> support::DartCObject {
        vec![self.id.into_dart(), self.device_id.into_dart(), self.kind.into_dart(), self.enabled.into_dart()].into_dart()
    }
}
...
impl support::IntoDart for PeerConnectionEvent {
    fn into_dart(self) -> support::DartCObject {
        match self {
            ...
            Self::IceCandidate { sdp_mid, sdp_mline_index, candidate } => vec![1.into_dart(), sdp_mid.into_dart(), sdp_mline_index.into_dart(), candidate.into_dart()],
            Self::IceGatheringStateChange(field0) => vec![2.into_dart(), field0.into_dart()],
            Self::IceCandidateError { address, port, url, error_code, error_text } => vec![3.into_dart(), address.into_dart(), port.into_dart(), url.into_dart(), error_code.into_dart(), error_text.into_dart()],
...
impl support::IntoDart for RtcRtpTransceiver {
    fn into_dart(self) -> support::DartCObject {
        vec![self.peer_id.into_dart(), self.index.into_dart(), self.mid.into_dart(), self.direction.into_dart()].into_dart()
    }
}
