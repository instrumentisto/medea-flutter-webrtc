...
fn wire_enable_fake_media_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, (), _>(
        ...
        move || move |task_callback| Result::<_, ()>::Ok(enable_fake_media()),
    )
}
fn wire_is_fake_media_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, bool, _>(
        ...
        move || move |task_callback| Result::<_, ()>::Ok(is_fake_media()),
    )
}
fn wire_enumerate_devices_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<MediaDeviceInfo>, _>(
        WrapInfo {
...
fn wire_enumerate_displays_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<MediaDisplayInfo>, _>(
        WrapInfo {
            debug_name: "enumerate_displays",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || move |task_callback| Result::<_, ()>::Ok(enumerate_displays()),
    )
}
...
fn wire_create_offer_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, RtcSessionDescription, _>(
        WrapInfo {
...
fn wire_get_transceivers_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<RtcRtpTransceiver>, _>(
        WrapInfo {
        ...
        move || {
            let api_peer = peer.wire2api();
            move |task_callback| Result::<_, ()>::Ok(get_transceivers(api_peer))
        },
    )
}
...
fn wire_get_transceiver_direction_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, RtpTransceiverDirection, _>(
        WrapInfo {
...
fn wire_get_peer_stats_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<RtcStats>, _>(
        WrapInfo {
...
fn wire_restart_ice_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, (), _>(
        ...
        move || {
            let api_peer = peer.wire2api();
            move |task_callback| Result::<_, ()>::Ok(restart_ice(api_peer))
        },
    )
}
...
fn wire_get_media_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, GetMediaResult, _>(
        WrapInfo {
        ...
        move || {
            ...
            move |task_callback| Result::<_, ()>::Ok(get_media(api_constraints))
        },
    )
}
...
fn wire_track_state_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, TrackState, _>(
        WrapInfo {
...
fn wire_clone_track_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, MediaStreamTrack, _>(
        WrapInfo {
...
fn wire_set_volume_observer_enabled_impl(
    port_: MessagePort,
    track_id: impl Wire2Api<String> + UnwindSafe,
    peer_id: impl Wire2Api<Option<u64>> + UnwindSafe,
    enabled: impl Wire2Api<bool> + UnwindSafe,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, (), _>(
        WrapInfo {
            debug_name: "set_volume_observer_enabled",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            ...
            let api_peer_id = peer_id.wire2api();
            let api_enabled = enabled.wire2api();
            move |task_callback| set_volume_observer_enabled(api_track_id, api_peer_id, api_enabled)
        },
    )
}
...
impl support::IntoDart for TrackEvent {
    fn into_dart(self) -> support::DartAbi {
        match self {
            ...
            Self::VolumeUpdated(field0) => vec![1.into_dart(), field0.into_into_dart().into_dart()],
        }
        .into_dart()
    }
}
...
mod io {
    ...
    #[no_mangle]
    pub extern "C" fn wire_set_volume_observer_enabled(
        port_: i64,
        track_id: *mut wire_uint_8_list,
        peer_id: *mut u64,
        enabled: bool,
    ) {
        wire_set_volume_observer_enabled_impl(port_, track_id, peer_id, enabled)
    }
