...
mod cpp_api_bindings {
    unsafe extern "C++" {
        ...
        // #[cxx_name = "OnSuccess"]
        // pub fn on_set_description_sucess(self: Pin<&mut SetDescriptionCallbackInterface>);
        ...
        // pub fn on_negotiation_needed(self: Pin<&mut PeerConnectionObserverInterface>);
