...
struct VideoFrame;
struct Frame;
using OnFrameCallbackInterface = ::OnFrameCallbackInterface;
...
#endif // CXXBRIDGE1_STRUCT_VideoFrame

#ifndef CXXBRIDGE1_STRUCT_Frame
#define CXXBRIDGE1_STRUCT_Frame
struct Frame final : public ::rust::Opaque {
  ~Frame() = delete;
